<?php
    ...
    elseif($_GET['act']=='edit'){
        ...
        if($_FILES['filesk']['name']==''){
            mysqli_query($conn, "UPDATE tb_suratkeluar SET no_suratkeluar='$no', no_agenda='$noag', tujuan_surat='$tujuan', klasifikasi='$kla', isi_surat='$isi', tgl_surat='$tglsk', tgl_keluar='$tglk', ket_suratkeluar='$ket', file_suratkeluar='$filelama' WHERE id_suratkeluar='$id'");
