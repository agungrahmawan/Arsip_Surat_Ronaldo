<?php
    ...
    elseif($_GET['act']=='edit'){
        ...
        if($_FILES['filesm']['name']==''){
            mysqli_query($conn, "UPDATE tb_suratmasuk SET no_suratmasuk='$no', no_agenda='$noag', asal_surat='$asal', klasifikasi='$kla', isi_surat='$isi', tgl_surat='$tglsm', tgl_diterima='$tgld', ket_suratmasuk='$ket', file_suratmasuk='$filelama' WHERE id_suratmasuk='$id'");
