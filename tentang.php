                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>Aplikasi ini saya buat untuk menyelesaikan Praktek Kerja Lapangan di Balai Desa Jati Wetan Kabupaten Kudus. Aplikasi ini dibuat menggunakan PHP, MYSQLI, Bootstrap 4</p>
                                    <p class="mb-0">
                                        <table>
                                            <tr>
                                                <td>Nama</td>
                                                <td class="pr-2">:</td>
                                                <td>Abdul Aziz Ronaldo</td>
                                            </tr>
                                            <tr>
                                                <td>Nim</td>
                                                <td>:</td>
